...
function MatchManager:ctor(match)
    ...
    local function update(dt)
        ...
        if #self.queue>0 and #self.listeners>0 then
            print(string.format("queue count %d ",#self.queue))
            print(string.format("listeners count %d ",#self.listeners))
...
function MatchManager:onReceivedMatched(data)
...
-- function MatchManager:sendDropMsg(nextIndex,index)
--     local startTetris = {
--         msgid = 1001,
--         msg_type = 0,
--         next = nextIndex,
